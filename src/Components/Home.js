 ...
 const addToCart =(title,price,id,quantity,imgSrc,description,category)=>{
  ...
  <Container id='home' height={'100vh'} maxW={'container.x1'}  >
    <HStack >
      ...
      <motion.Heading   {...animation.h1} marginTop={70} marginStart={-20} className='heading' >Menufy</motion.Heading>
      {/* <Text fontFamily={'cursive'} fontSize={40} paddingTop={2} >Find your favorite dishes at one click</Text> */}
    ...
    wrapperClassName:"typewriterpara"
      ...
      <a href={"#items"}>
        ...
        }} className='btnt' w={170} h={50} bgColor={'rgb(237, 86, 21)'}> <Text marginEnd={2}>Scroll</Text><FaArrowDown color='black' /></Button></a>
  ...
  <Container  height={'460vh'} id='items' maxW={'container.x1'}>
   <Box  id='boxx'>
